...
def sample_point_from_mesh(model_root,sample_points_from_model):
    mesh = o3d.io.read_triangle_mesh(model_root)
    pcd = mesh.sample_points_uniformly(number_of_points=sample_points_from_model)
    scale_factor = 0.001
...
def sample_point_from_mesh_with_color(model_root,sample_points_from_model):
    mesh = o3d.io.read_triangle_mesh(model_root)
    pcd = mesh.sample_points_uniformly(number_of_points=sample_points_from_model)
    scale_factor = 0.001
    pcd.scale(scale_factor,(0, 0, 0))
...
def x_axis_crop(pcd, min_overlap=0.3):
    ...
    #print('pcd ', pcd.shape)
    #print(x_min, ' ' , x_max, ' ', left_min, ' ', left_max, ' ', right_min,' ' , right_max)
